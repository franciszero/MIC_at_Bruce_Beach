...
AnnotationYOLOv8(batch_path, model_id=4, model_weights='./runs/detect/train30/weights/best.pt').foo()
AnnotationSahiYOLOv8(batch_path, model_id=5, model_weights='./runs/detect/train30/weights/best.pt').foo()
